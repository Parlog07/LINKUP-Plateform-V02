...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    Route::get('posts', [App\Http\Controllers\Admin\PostAdminController::class, 'index'])->name('posts.index');
    Route::post('posts/{post}/update-status', [App\Http\Controllers\Admin\PostAdminController::class, 'updateStatus'])->name('posts.updateStatus');
});
